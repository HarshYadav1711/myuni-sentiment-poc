...
| Contextual reasoner | OpenRouter HTTP (`minimax/minimax-m3:free` → `liquid/lfm-2.5-2.6b:free` → `minimax/minimax-m2.7:free`) |
...
| `OPENROUTER_REASONER_FALLBACK_MODELS` | `liquid/lfm-2.5-2.6b:free,minimax/minimax-m2.7:free` |
